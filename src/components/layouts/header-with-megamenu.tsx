  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'flex justify-between items-center w-full h-14 md:h-16 lg:h-22 px-4 lg:pl-16 rtl:lg:pr-16 lg:pr-16 rtl:lg:pl-16 py-5 bg-light transition-transform duration-300 relative z-10'
          )}
        >
          ...
          {isHomePage ? (
            <>
              {displayMobileHeaderSearch && (
                <div className="block lg:hidden w-full absolute top-0 left-0 rtl:right-0 h-full bg-light pt-1.5 md:pt-2 px-5">
          ...
          <div className="ml-10 rtl:mr-10 hidden lg:flex items-center shrink-0 space-x-9 rtl:space-x-reverse">
            ...
            >
              ...
              >
                ...
                {(item?.columns || item.subMenu) && (
                  <span className="opacity-30 text-heading text-xs mt-1 xl:mt-0.5 ml-1.5 rtl:mr-1.5 w-2.5 flex justify-end">
              ...
              {item?.subMenu && Array.isArray(item.subMenu) && (
                <div className="subMenu shadow-md border border-gray-200 bg-white absolute left-0 rtl:right-0 opacity-0 group-hover:opacity-100">
