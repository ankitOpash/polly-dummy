  ...
  return (
    <div
      className={classNames(
        ' flex h-14 items-center justify-between border-t border-b border-border-200 bg-light py-3 px-5 md:h-16 lg:px-7 xl:hidden',
        className
      )}
    >
      <button
      ...
      >
        <FilterIcon width="18" height="14" className="mr-2 rtl:ml-2" />
        Filter
      </button>
      <GroupsDropdownMenu />
    </div>
