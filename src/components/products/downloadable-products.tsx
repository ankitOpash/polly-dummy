          ...
          >
            ...
            <div className="flex w-full flex-col items-start sm:flex-row sm:justify-between sm:space-x-4 rtl:sm:space-x-reverse">
              <div className="flex w-full flex-col space-y-1 sm:items-start">
                <Link
                  href={`${Routes.products}/${isVariableProduct(item)
                ...
                >
                  ...
                  {isVariableProduct(item) && (
                    <>
                      ...
                      <span className="inline-block text-sm clear-left ml-1 rtl:clear-right rtl:mr-1">
              ...
              {isPaymentPending(
                ...
                <span className="order-2 mt-5 w-full max-w-full shrink-0 basis-full sm:order-1 lg:mt-0 lg:w-auto lg:max-w-none lg:basis-auto lg:ml-auto lg:rtl:mr-auto">
                  {/* <PayNowButton
