        ...
        {is_valid ? (
          <>
            ...
            {!copyText.copied && (
              ...
              >
                <button className="text-sm font-semibold text-accent transition-colors duration-200 hover:text-accent-hover focus:text-accent-hover focus:outline-0 text-right rtl:text-left">
                  <span>Copy</span>
                </button>
              </CopyToClipboard>
            )}
            ...
            {copyText.copied && (
              <div className="text-sm font-semibold text-accent text-right rtl:text-left">
                Copy
              </div>
            )}
          </>
