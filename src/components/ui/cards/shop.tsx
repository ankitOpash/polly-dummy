  ...
  return (
    <Link href={Routes.shop(shop.slug)}>
      <div className='relative flex cursor-pointer items-center rounded border border-gray-200 p-5'>
        {isNew && (
          <span className="absolute top-2 rounded bg-blue-500 px-2 py-1 text-xs text-light right-2 rtl:left-2">
            New
          </span>
        )}
        ...
        <div className="flex flex-col ml-4 rtl:mr-4">
          ...
          <span className="flex text-xs text-body">
            <MapPin className="h-3.5 w-3.5 shrink-0 text-muted mr-1 rtl:ml-1" />
