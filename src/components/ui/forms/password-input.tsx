      ...
      <div className={className}>
        ...
        <div className="relative">
          <input
            ...
            ref={ref}
            className={cn(
              'w-full appearance-none rounded py-3 text-sm text-heading transition duration-300 ease-in-out focus:outline-0 focus:ring-0 pl-4 pr-11 rtl:pr-4 rtl:pl-11',
              shadow && 'focus:shadow',
          ...
          <label
            htmlFor={name}
            className="absolute top-5 -mt-2 cursor-pointer text-body right-4 rtl:left-4"
