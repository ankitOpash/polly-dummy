...
const MegaMenu: React.FC<MegaMenuProps> = ({ columns }) => {
  ('menu');
  return (
    <div className="megaMenu shadow-header bg-white absolute border border-gray-200 left-0 rtl:right-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible shadow-md">
