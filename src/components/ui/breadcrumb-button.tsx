...
const BreadcrumbButton: React.FC<BreadcrumbButtonProps> = ({
  ...
  >
    ...
    {image && (
      <span className="absolute bottom-0 h-full w-14 overflow-hidden rounded-lg right-0 rounded-l-none rtl:left-0 rtl:rounded-r-none">
        <Image
