...
function SolidBoxedCategoryMenu({ items }: any) {
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={prevRef}
        className="category-slider-prev absolute top-1/2 z-10 -mt-4 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-light text-heading shadow-300 outline-none focus:outline-none -left-3 rtl:-right-3 lg:-left-4"
      >
      ...
      <div
        ref={nextRef}
        className="category-slider-next absolute top-1/2 z-10 -mt-4 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-light text-heading shadow-300 outline-none focus:outline-none -right-3 rtl:-left-3 lg:-right-4 rtl:lg:-left-4"
      >
