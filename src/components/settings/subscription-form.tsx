    ...
    <div className="flex flex-col">
      ...
      >
        {({ register, formState: { errors } }) => (
          <>
            <div className="relative w-full rounded border border-gray-200 bg-gray-50 pr-11 rtl:pl-11">
              <input
                type="email"
                id="email_subscribe"
                {...register('email')}
              ...
              />
              <button className="absolute top-1/2 -mt-2 right-3 rtl:left-3">
                {loading ? (
                  <span
                    className="flex h-5 w-5 shrink-0 animate-spin rounded-full border-[3px] border-t-[3px] border-gray-300 text-accent ml-2 rtl:mr-2"
                    style={{
